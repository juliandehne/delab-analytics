...
def init_topic_models():
    print("START initializing topic_model")
    # specify topic model
    # model path
    dirname = os.getcwd()
    ...
    print("FINISH initializing topic_model")
    return topic_model, vectorizer_model, representation_model


# tm function
def delab_bertopic(docs, topic_model=None, vectorizer_model=None, representation_model=None):
